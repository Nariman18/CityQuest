  ...
  return (
    <div className='relative h-[550px] sm:h-[650px] lg:h-[750px] xl:h-[850px] 2xl:h-[950px]'>
        ...
        <div className='absolute top-1/3 w-full text-center'>
            ...
            <button className="text-white bg-orange-500 px-10 py-4 shadow-md border mt-9 font-bold my-3 hover:bg-white hover:text-orange-500 active:scale-90 transition duration-150 uppercase animate-animatepulse">Начать</button> 
        </div>
    </div>
  )
}
