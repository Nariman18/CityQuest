...
function InFootstepsOfOldCity() {
  ...
  return (
    <div className='bg-[#171717] flex flex-col items-center'>
       ...
       <p className='uppercase text-white absolute 2xl:text-5xl xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-2xl font-semibold'>вперёд в будущее</p>
       </div>

       <div className='flex flex-col justify-center items-center mt-14'>

        <div className='relative 2xl:w-[1200px] xl:w-[1200px] lg:w-[900px] lg:h-[700px] md:w-[600px] md:h-[400px] sm:w-[600px] sm:h-[340px] 2xl:h-[800px] xl:h-[800px] w-[360px] h-[240px]'>
