...
function Banner2() {
  return (
    <div className='relative h-[400px] flex items-center justify-center'>
        ...
        <p className='absolute text-white top-[90px] 2xl:text-[17px] xl:text-[17px] lg:text-[17px] md:text-[17px] sm:text-[17px] text-[18px] font-lobstertwo'>Почувствуем силу командного духа!</p>
