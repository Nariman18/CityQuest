...
function Banner2() {
  return (
    <div className='relative h-[400px] flex items-center justify-center'>
        ...
        <p className='absolute text-white mb-[200px] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[18px] font-lobstertwo'>Почувствуем силу командного духа!</p>
